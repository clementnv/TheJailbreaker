...
if (distance_to_object(o_Player) > 150 && state != "touch" && state != "dead") {
	...
	if(state != "touch" && state != "dead") {
		if (distx > zone && disty > zone && !place_meeting(x+walkspd/2, y+walkspd/2, o_Wall) && !place_meeting(x+walkspd/2, y+walkspd/2, o_Bed) && !place_meeting(x+walkspd/2, y+walkspd/2, o_Desk) && !place_meeting(x+walkspd/2, y+walkspd/2, o_Table) && !place_meeting(x+walkspd/2, y+walkspd/2, o_Out)) {
			image_angle = 225;
			x+=walkspd/2;
			y+=walkspd/2;
			state = "walk";
		} else if (distx > zone && disty < -zone && !place_meeting(x+walkspd/2, y-walkspd/2, o_Wall) && !place_meeting(x+walkspd/2, y-walkspd/2, o_Bed) && !place_meeting(x+walkspd/2, y-walkspd/2, o_Desk) && !place_meeting(x+walkspd/2, y-walkspd/2, o_Table) && !place_meeting(x+walkspd/2, y-walkspd/2, o_Out)) {
			image_angle = -45;
			x+=walkspd/2;
			y-=walkspd/2;
			state = "walk";
			...
			y+=walkspd;
			state = "walk";
		} else if(!couldown && !place_meeting(x, y, o_Wall)) {
			state ="attack";
			if (luck == 1) {
				o_Player.walkspd = 2;
				o_Player.hp -= 1;
