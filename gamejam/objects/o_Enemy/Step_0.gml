...
/// @DnDVersion : 1
/// @DnDHash : 3C221C78
/// @DnDArgument : "code" "if (state == "walk") {$(13_10)	sprite_index = s_Policier_Walk;$(13_10)} else if(state == "idle") {$(13_10)	sprite_index = s_Policier_Idle;$(13_10)} else if(state == "attack") {$(13_10)	sprite_index = s_Policier_Mattraque_Attack;$(13_10)}$(13_10)$(13_10)show_debug_message(distance_to_object(o_Player))"
if (state == "walk") {
