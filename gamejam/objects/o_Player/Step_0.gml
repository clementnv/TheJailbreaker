...
if(keyboard_check(vk_left) or gamepad_button_value(0, gp_padl) or (gamepad_axis_value(0, gp_axislh) == -1)) {
	press_left = true;
} else {
	press_left = false;
}
if(keyboard_check(vk_up) or gamepad_button_value(0, gp_padu) or (gamepad_axis_value(0, gp_axislv) == -1)) {
	press_up = true;
} else {
	press_up = false;
}
